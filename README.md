...
### makler.md
**Основные поля (со страницы списка):**
- Заголовок
- Описание (краткое)
- Локация
- Телефон
...
**Детальные поля (с страницы вакансии):**
...
### 3. makler.md
- **Технология:** Puppeteer с имитацией человеческой активности
- **Защита:** Cloudflare (обходится автоматически)
- **Статус:** ✅ Работает
- **Детальный парсинг:** ✅ Форма занятости, график, образование, сфера, специализация
